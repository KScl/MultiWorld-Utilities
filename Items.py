...
item_hint_text = {
    'Nothing':                        ('nothing',                "Surprise!\nIt's literally\nnothing", None, 'The sword\nis a lie', None),
    # Swords
    'Fighter Sword & Shield':         ('the Sword and Shield',   "Your uncle's\narmaments lay\nhere together", None, None, None),
    'Fighter Sword':                  ('the Fighter Sword',      'A pathetic\nsword rests\nhere!', None, None, None),
    'Master Sword':                   ('the Master Sword',       'I beat barries and pigs alike', None, 'I thought this\nwas meant to\nbe randomized?', 'Look at me!\nI am the\npedestal!'),
    'Tempered Sword':                 ('the Tempered Sword',     "I stole the\nblacksmith's\njob!", None, None, None),
    'Golden Sword':                   ('the Golden Sword',       'The butter\nsword rests\nhere!', None, None, None),
    'Progressive Sword':              ('a Sword',                'a better copy\nof your sword\nfor your time', None, None, None),
    # Shields
    'Blue Shield':                    ('the Blue Shield',        'Now you can\ndefend against\npebbles!', None, None, None),
    'Red Shield':                     ('the Red Shield',         'Now you can\ndefend against\nfireballs!', None, None, None),
    'Mirror Shield':                  ('the Mirror Shield',      'Now you can\ndefend against\nlasers!', None, None, None),
    'Progressive Shield':             ('a shield',               'have a better\nblocker in\nfront of you', None, None, None),
    # Mail / Armor
    'Blue Mail':                      ('the Blue Mail',          "Now you're a\nblue elf!", None, None, None),
    'Red Mail':                       ('the Red Mail',           "Now you're a\nred elf!", None, None, None),
    'Progressive Mail':               ('some armor',             'time for a\nchange of\nclothes?', None, None, None),
    # Gloves
    'Power Glove':                    ('the Glove',              'Now you can\nlift weak\nstuff!', None, None, None),
    'Titans Mitts':                   ('the Mitts',              'Now you can\nlift heavy\nstuff!', None, None, None),
    'Progressive Glove':              ('a glove',                'a way to lift\nheavier things', None, None, None),
    # Bow
    'Bow':                            ('the Bow',                'You have\nchosen the\narcher class.', None, None, None),
    'Progressive Bow':                ('a Bow',                  'You have\nchosen the\narcher class.', None, None, None),
    'Progressive Bow (Alt)':          ('a Bow',                  'You have\nchosen the\narcher class.', None, None, None),
    'Silver Bow':                     ('the Silver Bow',         'Buy 1 Silver\nget Archery\nfor free.', None, None, None),
    'Silver Arrows':                  ('the Silver Arrows',      'Do you fancy\nsilver tipped\narrows?', None, None, None),
    # Medallions
    'Bombos':                         ('Bombos',                 'Burn, baby,\nburn! Fear my\nring of fire!', None, None, None),
    'Ether':                          ('Ether',                  'This magic\ncoin freezes\neverything!', None, None, None),
    'Quake':                          ('Quake',                  'Maxing out the\nRichter scale\nis what I do!', None, None, None),
    # Boomerangs
    'Blue Boomerang':                 ('the Blue Boomerang',     'No matter what\nyou do, blue\nreturns to you', None, None, None),
    'Red Boomerang':                  ('the Red Boomerang',      'No matter what\nyou do, red\nreturns to you', None, None, None),
    # Flutes
    'Flute':                          ('the Flute',              'Save the duck\nand fly to\nfreedom!', None, None, None),
    'Activated Flute':                ('the Flute',              'Save the duck\nand fly to\nfreedom!', None, None, None),
    # One-off Unique Items
    'Book of Mudora':                 ('the Book',               'Hylian for\nDingusses,\n2nd Edition', None, 'This is a\nparadox?!', 'This is a\nparadox?!'),
    'Bug Catching Net':               ('the Bug Net',            "Let's catch\nsome bees and\nfaeries!", None, None, None),
    'Cane of Byrna':                  ('the Blue Cane',          'Use this to\nbecome\ninvincible!', None, None, None),
    'Cane of Somaria':                ('the Red Cane',           'I make blocks\nto hold down\nswitches!', None, None, None),
    'Cape':                           ('the Cape',               'Wear this to\nbecome\ninvisible!', None, None, None),
    'Fire Rod':                       ('the Fire Rod',           "I'm the hot\nrod. I make\nthings burn!", None, None, None),
    'Flippers':                       ('the Flippers',           'Fancy a swim?', None, 'The water is\ncalm. Do you\nwant to surf?', 'The water is\ncalm. Do you\nwant to surf?'),
    'Ice Rod':                        ('the Ice Rod',            "I'm the cold\nrod. I make\nthings freeze!", None, None, None),
    'Hammer':                         ('the Hammer',             '     STOP!\nhammer time!', None, None, None),
    'Hookshot':                       ('the Hookshot',           'BOING!!!\nBOING!!!\nBOING!!!', None, None, None),
    'Lamp':                           ('the Lamp',               'Baby, baby,\nbaby.\nLight my way!', None, None, None),
    'Magic Mirror':                   ('the Mirror',             "Isn't your\nreflection so\npretty?", None, None, None),
    'Magic Powder':                   ('the Powder',             'you can turn\nanti-faeries\ninto faeries', None, None, None),
    'Moon Pearl':                     ('the Moon Pearl',         '  Bunny Link\n      be\n     gone!', None, None, None),
    ...
    # Upgrades
    'Magic Upgrade (1/2)':            ('a magic upgrade',        'Your magic\npower has been\ndoubled!', None, None, None),
    'Magic Upgrade (1/4)':            ('a magic upgrade',        'Your magic\npower has been\nquadrupled!', None, None, None),
    'Bomb Upgrade (+5)':              ('bomb capacity',          'increase bomb\nstorage, low\nlow price', None, None, None),
    'Bomb Upgrade (+10)':             ('bomb capacity',          'increase bomb\nstorage, low\nlow price', None, None, None),
    'Arrow Upgrade (+5)':             ('arrow capacity',         'increase arrow\nstorage, low\nlow price', None, None, None),
    'Arrow Upgrade (+10)':            ('arrow capacity',         'increase arrow\nstorage, low\nlow price', None, None, None),
    # Heart Containers
    'Boss Heart Container':           ('a heart container',      'Maximum health\nincreased!\nYeah!', None, None, None),
    'Sanctuary Heart Container':      ('a heart container',      'Maximum health\nincreased!\nYeah!', None, None, None),
    'Piece of Heart':                 ('a piece of heart',       'Just a little\npiece of love!', None, None, None),
    # Junk Items
    'Single Arrow':                   ('an arrow',               'a lonely arrow\nsits here.', None, None, None),
    'Arrows (10)':                    ('ten arrows',             'This will give\nyou ten shots\nwith your bow!', None, None, None),
    'Single Bomb':                    ('a bomb',                 'I make things\ngo BOOM!\nBut just once.', None, None, None),
    'Bombs (3)':                      ('three bombs',            'I make\nthings go\ntriple BOOM!!!', None, None, None),
    'Bombs (10)':                     ('ten bombs',              'I make things\ngo BOOM!\nTen times!', None, None, None),
    'Rupee (1)':                      ('a green rupee',          'Just pocket\nchange. Move\nright along.', None, None, None),
    'Rupees (5)':                     ('a blue rupee',           'Just pocket\nchange. Move\nright along.', None, None, None),
    'Rupees (20)':                    ('a red rupee',            'Just couch\ncash. Move\nright along.', None, None, None),
    'Rupees (50)':                    ('fifty rupees',           'Just couch\ncash. Move\nright along.', None, None, None),
    'Rupees (100)':                   ('100 rupees',             'A rupee stash!\nHell yeah!', None, None, None),
    'Rupees (300)':                   ('300 rupees',             'A rupee hoard!\nHell yeah!', None, None, None),
    'Rupoor':                         ('a Rupoor',               'pay me for the\npedestal\nrepair charge.', 'pay me for the\ntablet\nrepair charge.', None, None),
    'Small Heart':                    ('a recovery heart',       'Feeling\naffectionate\ntoday?', None, None, None),
    # Bottles
    'Bottle':                         ('a bottle',               'Now you can\nstore potions\nand stuff!', None, None, None),
    ...
    'Red Clock':                      ('a red clock',            'like the sands\nthrough a red\nhourglass', None, None, None),
    'Blue Clock':                     ('a blue clock',           'sapphire sand\ntrickles down', None, None, None),
    'Green Clock':                    ('a green clock',          'time keeps on\nslipping, \nslipping', None, None, None),
    'Apple':                          ('apples',                 "They're more\nlike giant\ncherries…", None, None, None),
    'Bee Trap':                       ('Friendship',             'We will sting\nyour face a\nwhole lot!', None, None, None),
    ...
    # Free Maps
    'Map (Hyrule Castle)':            ('a map of Hyrule Castle',            'a folded map\nto the castle\nof Hyrule', None, None, None),
    'Map (Eastern Palace)':           ('a map of Eastern Palace',           'a folded map\nto the palace\nto the east', None, None, None),
    'Map (Desert Palace)':            ('a map of Desert Palace',            'a folded map\nto the palace\nin the desert', None, None, None),
    'Map (Tower of Hera)':            ('a map of Tower of Hera',            'a folded map\nto the tower\nof Moldorm', None, None, None),
    'Map (Agahnims Tower)':           ("a map of Agahnim's Tower",          'a folded map\nto the tower\nof Agahnim', None, None, None),
    'Map (Palace of Darkness)':       ('a map of Palace of Darkness',       'a folded map\nto the Palace\nof Darkness', None, None, None),
    'Map (Swamp Palace)':             ('a map of Swamp Palace',             'a folded map\nto a swampy\nPalace', None, None, None),
    'Map (Skull Woods)':              ('a map of Skull Woods',              'a folded map\nto the ghastly\nwoods', None, None, None),
    'Map (Thieves Town)':             ("a map of Thieves' Town",            'a folded map\nto a town\nof thievery', None, None, None),
    'Map (Ice Palace)':               ('a map of Ice Palace',               'a folded map\nto an Ice-\ncold palace', None, None, None),
    'Map (Misery Mire)':              ('a map of Misery Mire',              'a folded map\nwhere Misery\nawaits you', None, None, None),
    'Map (Turtle Rock)':              ('a map of Turtle Rock',              'a folded map\nto the domain\nof turtles', None, None, None),
    'Map (Ganons Tower)':             ("a map of Ganon's Tower",            'a folded map\nto the most\nevil tower', None, None, None),
    # Free Compasses
    'Compass (Hyrule Castle)':        ('the compass of Hyrule Castle',      'Compass was\ndefective.\n0 out of 10.', None, None, None),
    'Compass (Eastern Palace)':       ('the compass of Eastern Palace',     'Now you\ncan find the\nArmos Knights!', None, None, None),
    'Compass (Desert Palace)':        ('the compass of Desert Palace',      'Now you\ncan find\nLanmolas!', None, None, None),
    'Compass (Tower of Hera)':        ('the compass of Tower of Hera',      'Now you\ncan find\nMoldorm!', None, None, None),
    'Compass (Agahnims Tower)':       ("the compass of Agahnim's Tower",    'Now you\ncan find\nAgahnim!', None, None, None),
    'Compass (Palace of Darkness)':   ('the compass of Palace of Darkness', 'Now you\ncan find\nHelmasaur!', None, None, None),
    'Compass (Swamp Palace)':         ('the compass of Swamp Palace',       'Now you\ncan find\nArrghus!', None, None, None),
    'Compass (Skull Woods)':          ('the compass of Skull Woods',        'Now you\ncan find\nMothula!', None, None, None),
    'Compass (Thieves Town)':         ("the compass of Thieves' Town",      'Now you\ncan find\nBlind!', None, None, None),
    'Compass (Ice Palace)':           ('the compass of Ice Palace',         'Now you\ncan find\nKholdstare!', None, None, None),
    'Compass (Misery Mire)':          ('the compass of Misery Mire',        'Now you\ncan find\nVitreous!', None, None, None),
    'Compass (Turtle Rock)':          ('the compass of Turtle Rock',        'Now you\ncan find\nTrinexx!', None, None, None),
    'Compass (Ganons Tower)':         ("the compass of Ganon's Tower",      'Now you\ncan find\nAgahnim again!', None, None, None),
    # Goal Items
    'Triforce':                       ('the Triforce',     'You found\nthe goal…', 'You found\nthe goal…', '\n   YOU WIN!', '\n   YOU WIN!'),
    'Power Star':                     ('a Power Star',     "Aim for the\nmoon. You may\nhit a 'star'", "Watch for\nfalling stars", None, None),
    'Triforce Piece':                 ('a Triforce Piece', "please don't\neat the shiny\ngolden dorito.", "Watch for\nfalling\ntriangles", None, None),
}
...
item_credit_text = {
    ...
    # Free Compasses
    'Compass (Hyrule Castle)':        ('and the boss pointer',  'the magnetic kid',    'compass for sale',      'magnetic fungus',          'compass boy finds boss again',     'your uncle is magnetic'),
    ...
    'Compass (Agahnims Tower)':       ('and the broken magnet', 'the lost kid',        'water-damaged compass', 'magnets, how do they work','compass boy finds nothing again',  'your uncle is lost'),
