...
item_table = {'Bow': (True, None, 0x0B, 'You have\nchosen the\narcher class.', 'the stick and twine', 'arrow-slinging kid', 'arrow sling for sale', 'witch and robin hood', 'archer boy shoots again', 'the Bow'),
              ...
              'Fighter Sword & Shield': (True, 'Sword', 0x00, 'Your uncle\'s\narmaments lay\nhere together', 'the sword and shield', 'monster-hunting kid', 'tiny sword for sale', 'fungus for tiny slasher', 'sword boy fights again', 'the Sword and Shield'),
              ...
              'Fighter Sword': (True, 'Sword', 0x49, 'A pathetic\nsword rests\nhere!', 'and the tiny sword', 'sword-wielding kid', 'tiny sword for sale', 'fungus for tiny slasher', 'sword boy fights again', 'the Small Sword'),
              ...
              'Power Star': (True, None, 0x6B, 'Aim for the\nmoon. You may\nhit a \'star\'', 'and the power star', 'star-struck kid', 'star for sale', 'see stars with shroom', 'mario powers up again', 'a Power Star'),
              'Triforce Piece': (True, None, 0x6C, 'please don\'t\neat the shiny\ngolden dorito.', 'and the thirdforce', 'triangular kid', 'triangle for sale', 'fungus for triangle', 'wise boy has triangle again', 'a Triforce Piece'),
              ...
              'Rupoor': (False, None, 0x59, 'pay me for the\npedestal\nrepair charge.', 'and the toll-booth', 'the toll-booth kid', 'double loss for sale', 'witch stole your rupees', 'affluent boy steals rupees', 'a rupoor'),
              'Red Clock': (False, None, 0x5B, 'like the sands\nthrough a red\nhourglass', 'the ruby clock', 'the ruby-time kid', 'red time for sale', 'for ruby time', 'moment boy travels time again', 'a red clock'),
              'Blue Clock': (False, None, 0x5C, 'sapphire sand\ntrickles down', 'the sapphire clock', 'sapphire-time kid', 'blue time for sale', 'for sapphire time', 'moment boy time travels again', 'a blue clock'),
              'Green Clock': (False, None, 0x5D, 'time keeps on\nslipping, \nslipping', 'the emerald clock', 'the emerald-time kid', 'green time for sale', 'for emerald time', 'moment boy adjusts time again', 'a green clock'),
